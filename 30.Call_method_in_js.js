// Call method in js is used so thay when there is a function call inside a function itself then we need to hold its reference because u know if we are not holding that reference then u cant retain the value from that function...See a example below to understand more clearly.
