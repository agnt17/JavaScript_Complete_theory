...
let obj1 = Object.create({ name1: "Aditya" }); // creating a object name using 'Object' constructor
...
// u can thought of an object as an array bs itna frq hai ki arrays me hum apne hisab se indexing kisi bhi data type ki kr skte means array me kya scene tha ki wha indexing keval 0, 1, 2 in form me hoti thi but yha pr indexing string array number or infact object jaisi bhi ho skti hai.

// freeze function
let obj2 = {
  name: "Aditya",
  Field: "IT",
  Badges: "Chief Commander",
  alias: ["Agent17", "Bravo-Charlie", "LockHeed-martin"],
  email: "ghost_of_kashmir@indian_army.com",
};
// console.log(obj2);
obj2.email = "Are_u_sure_sergeant@indian_army.com";
// console.log(obj2);

Object.freeze(obj2);
obj2.email = "Copy_that_sir@indian_army.com";
...
let Array_module = [  
  {
    name: "Aditya",
    Field: "IT",
    Badges: "Lieutenant Colonel",
    alias: ["Agent17", "Bravo-Charlie", "GhostDeath"],
    email: "Terror_to_pak@indian_army.com",
  },
  {
    name: "anurag",
    Field: "IT",
    Badges: "Lieutenant general",
    alias: ["Pikapi", "Bravo18", "agent88"],
    email: "Terror_to_pak07@indian_army.com",
  },
  {
    name: "nau",
    Field: "lineman",
    Badges: "Lieutenant",
    alias: ["kauva", "pepee", "natural_cause"],
    email: "Terror_to_pak08@indian_army.com",
  },
];
