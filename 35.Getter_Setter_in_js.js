// getter and setter are used to get and set the values. If we want to change the value means what we have recieved if w want to change when it is accessed by any other person also getter and setters are used with each other they cant be used alone.
